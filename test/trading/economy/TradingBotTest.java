...
public class TradingBotTest {
	...
	static {
		...
		AcceptabilityFunction af = AcceptabilityFunction.checkType(true, List.of("Outta' Sight", "Bunsen Brave"), true, List.of(Effect.forName("Searing Plasma")));
	...
	public void testGetBuyListings() {
		assertEquals(Set.copyOf(withoutHats.getBuyListings()), Set.of(
				new Item("Outta' Sight", Quality.UNUSUAL, Effect.forName("Searing Plasma")),
				new Item("Bunsen Brave", Quality.UNUSUAL, Effect.forName("Searing Plasma"))
		));
	...
	public void testRecalculatePrices() throws IOException, NonVisibleListingException {
		...
		assertEquals(listings.get(new Item("Bunsen Brave", Quality.UNUSUAL, Effect.forName("Searing Plasma"))).getPrice(), new Price(23, 10));
	...
	public void testTradeOfferFunctions() throws IOException {
		...
		TradingBot shouldDecline = TradingBot.fromJSONRepresentation(
				new JSONObject("{\"id\": \"\", \"hats\": [{\"name\": \"Backwards Ballcap\", \"effect\": 14, \"communityPrice\": {\"lower\": {\"keys\": 10, \"metal\": 0}, \"middle\": {\"keys\": 10, \"metal\": 0}, \"upper\": {\"keys\": 10, \"metal\": 0}}, \"id\": \"A\", \"dateBought\": \"1961-01-17\", \"price\": {\"keys\": 40, \"metal\": 10}, \"boughtAt\": {\"keys\": 10, \"metal\": 5}}], "
						+ "\"buyListings\": [{\"name\": \"Lumbricus Lid\", \"effect\": 12, \"communityPrice\": {\"lower\": {\"keys\": 10, \"metal\": 0}, \"middle\": {\"keys\": 10, \"metal\": 0}, \"upper\": {\"keys\": 10, \"metal\": 0}}, \"price\": {\"keys\": 10, \"metal\": 5}}]}]}"), 
		...
		TradingBot shouldAccept = TradingBot.fromJSONRepresentation(
				new JSONObject("{\"id\": \"\", \"hats\": [{\"name\": \"Backwards Ballcap\", \"effect\": 14, \"communityPrice\": {\"lower\": {\"keys\": 10, \"metal\": 0}, \"middle\": {\"keys\": 10, \"metal\": 0}, \"upper\": {\"keys\": 10, \"metal\": 0}}, \"id\": \"A\", \"dateBought\": \"1961-01-17\", \"price\": {\"keys\": 10, \"metal\": 5}, \"boughtAt\": {\"keys\": 10, \"metal\": 5}}], "
						+ "\"buyListings\": [{\"name\": \"Lumbricus Lid\", \"effect\": 12, \"communityPrice\": {\"lower\": {\"keys\": 10, \"metal\": 0}, \"middle\": {\"keys\": 10, \"metal\": 0}, \"upper\": {\"keys\": 10, \"metal\": 0}}, \"price\": {\"keys\": 40, \"metal\": 10}}]}]}"), 
				tfConnection, functions
		);
		...
		assertEquals((int)shouldBeDeclined.itemsToReceive().get(new Item("Lumbricus Lid", Quality.UNUSUAL, Effect.forInt(12))), 10 * keyScrapRatio + 45);
		assertEquals((int)shouldBeAccepted.itemsToReceive().get(new Item("Lumbricus Lid", Quality.UNUSUAL, Effect.forInt(12))), 40 * keyScrapRatio + 90);
	
		shouldDecline.updateItemsAfterOffer(shouldBeDeclined);
		assertEquals(shouldAccept, shouldDecline);
		shouldAccept.updateItemsAfterOffer(shouldBeAccepted);
		Hat h = shouldAccept.getHats().get(new Item("Lumbricus Lid", Quality.UNUSUAL, Effect.forInt(12)));
		assertNotNull(h);
		assertEquals(h.getDateBought(), LocalDate.now());
		assertEquals(h.getPurchasePrice(), new Price(40, 10));
		BuyListing bl = shouldAccept.getBuyListings().get(new Item("Lumbricus Lid", Quality.UNUSUAL, Effect.forInt(12)));
		assertNull(bl);
		...
		testExpectedException(() -> {shouldDecline.updateItemsAfterOffer(null);}, NullPointerException.class);
		...
		TradingBot nonVisibleListing = TradingBot.fromJSONRepresentation(
				new JSONObject("{\"id\": \"\", \"hats\": [{\"name\": \"Backwards Ballcap\", \"effect\": 14, \"communityPrice\": {\"lower\": {\"keys\": 10, \"metal\": 0}, \"middle\": {\"keys\": 10, \"metal\": 0}, \"upper\": {\"keys\": 10, \"metal\": 0}}, \"id\": \"A\", \"dateBought\": \"1961-01-17\", \"price\": {\"keys\": 40, \"metal\": 10}, \"boughtAt\": {\"keys\": 10, \"metal\": 5}}], "
						+ "\"buyListings\": [{\"name\": \"Lumbricus Lid\", \"effect\": 12, \"communityPrice\": {\"lower\": {\"keys\": 10, \"metal\": 0}, \"middle\": {\"keys\": 10, \"metal\": 0}, \"upper\": {\"keys\": 10, \"metal\": 0}}, \"price\": null}]}]}"), 
				tfConnection, functions
		);
		testExpectedException(() -> {noListing.updateItemsAfterOffer(null);}, IllegalArgumentException.class);
		testExpectedException(() -> {nonVisibleListing.updateItemsAfterOffer(null);}, IllegalArgumentException.class);
	...
	public void testReadHatsFromInventory() throws IOException, NonVisibleListingException {
		TradingBot withoutHatsCopy = TradingBot.fromJSONRepresentation(withoutHats.getJSONRepresentation(), tfConnection, functions);
		withoutHatsCopy.readHatsFromInventory(steamConnection, 0.8);
		ListingCollection<Hat> hats = withoutHatsCopy.getHats();
